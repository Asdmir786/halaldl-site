    ...
    <SectionShell>
      ...
      <div className="grid gap-12 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:gap-16">
        <SectionIntro
          ...
          body="GitHub Releases is canonical. Checksums are attached. SmartScreen may warn because the installers are not code-signed yet. That should read like a practical checklist, not a vague reassurance panel."
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-ink-soft">
                    The safe path is visible: download from GitHub Releases, verify the checksum,
                    then decide how you want to handle the SmartScreen warning.
                  </p>
                </div>
              </div>
