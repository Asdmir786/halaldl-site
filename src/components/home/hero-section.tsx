...
export function HeroSection({ github }: { github: GitHubSnapshot }) {
  ...
  return (
    <section className="relative pt-16 sm:pt-20 lg:pt-24">
      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-center lg:gap-12 xl:gap-16">
        <ScrollReveal className="max-w-xl lg:max-w-none lg:pr-4">
        ...
        <ScrollReveal className="relative lg:pl-2" delay={0.06}>
          ...
          <div className="absolute -bottom-5 left-4 right-4 sm:left-auto sm:right-7 sm:w-[18rem]">
      ...
      <ScrollReveal className="mt-16 lg:mt-20">
        <SignalBand items={signalBandItems} />
      </ScrollReveal>
